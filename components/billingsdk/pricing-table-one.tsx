          ...
          <div className={cn(
            ...
            {monthlyOnly ? (
              <div className={cn(toggleVariants({ theme }), theme === "classic" && "mx-auto")}>
                <div className="h-full rounded-md bg-background border border-border/50">
                  <div className="flex h-full items-center justify-center px-2 md:px-7 font-semibold text-primary">
                    Monthly
                  </div>
                </div>
              </div>
